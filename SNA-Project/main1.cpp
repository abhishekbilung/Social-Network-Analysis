...
public:
    ...
    int followingsCount;
    vector<Post> posts;
    vector<pair<int, string>> followers;   // List of followers with their ID and name
    vector<pair<int, string>> followings;  // List of followings with their ID and name
